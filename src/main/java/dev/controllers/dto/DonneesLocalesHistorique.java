...
/**
 * @author Cécile
 * Objet Dto qui va servir à l'affichage de l'historique
 * il sera retourné sous forme de liste pour afficher toute la période pour un polluant donné.
 */
public class DonneesLocalesHistorique {

    /**
     * objet Dto polluantDtoVisualisation qui reprend les informations indispensables pour l'affichage :
     * le nom, la valeur et l'unité
     */
    private PolluantDtoVisualisation polluantDtoVisualisation;

    /**
     * objet dto CommuneDtoVisualisation qui reprend les informations indispensables pour l'affichage :
     * le nom de la commune et le nombre d'habitants
     */
