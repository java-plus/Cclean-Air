...
public class Polluant {
    ...
    public String toString() {
        return new ToStringBuilder(this).append("id", id).append("nom", nom).append("code", code).append("unite", unite).append("seuils", seuils).append("additionalProperties", additionalProperties).toString();
    }
