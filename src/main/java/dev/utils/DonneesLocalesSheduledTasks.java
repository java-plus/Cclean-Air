...
public class DonneesLocalesSheduledTasks {
    ...
    public DonneesLocalesSheduledTasks(DonneesLocalesService donneesLocalesService,
                                       ...
                                       QualiteAirService qualiteAirService, PolluantService polluantService) {
    ...
    /**
     * Méthode lançant périodiquement (chaque jour à 3h00 du matin) la méthode permettant de purger les données de plus
     * de 7 jours (données locales, données météorologiques et données de pollution).
     */
    ...
    public void purgerDonneesLocales() throws DonneesLocalesSheduledTasksException {
        ...
        try {
            ...
            throw new DonneesLocalesSheduledTasksException("ERREUR : La purge automatique de la base de données a " +
